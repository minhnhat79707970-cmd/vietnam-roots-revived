...
export const regionsData: Record<RegionSlug, RegionDetailData> = {
  bac: {
    ...
    landmarks: [
      { name: "Hồ Hoàn Kiếm & Phố cổ Hà Nội", province: "Hà Nội", type: "Đô thị cổ", highlight: "Trái tim ngàn năm văn hiến với 36 phố phường, đền Ngọc Sơn và cầu Thê Húc.", image: "hanoi-old-quarter" },
      { name: "Vịnh Hạ Long", province: "Quảng Ninh", type: "Biển đảo", highlight: "Gần 2.000 hòn đảo đá vôi giữa biển ngọc — kỳ quan thiên nhiên thế giới.", image: "halong-bay" },
      { name: "Sa Pa & Fansipan", province: "Lào Cai", type: "Núi", highlight: "Nóc nhà Đông Dương 3.143m, ruộng bậc thang Mường Hoa, chợ tình bản Cát Cát.", image: "sapa-fansipan" },
      { name: "Tràng An — Tam Cốc", province: "Ninh Bình", type: "Danh thắng", highlight: "'Hạ Long trên cạn' với hệ thống hang động xuyên thuỷ và cố đô Hoa Lư.", image: "trang-an" },
      { name: "Hồ Ba Bể", province: "Bắc Kạn", type: "Sông hồ", highlight: "Hồ nước ngọt tự nhiên lớn nhất Việt Nam giữa rừng nguyên sinh đá vôi.", image: "ba-be-lake" },
      { name: "Cao nguyên đá Đồng Văn", province: "Hà Giang", type: "Danh thắng", highlight: "Công viên địa chất toàn cầu UNESCO với đèo Mã Pí Lèng và sông Nho Quế.", image: "ha-giang" },
      { name: "Mù Cang Chải", province: "Yên Bái", type: "Danh thắng", highlight: "Ruộng bậc thang vàng óng mùa lúa chín — kiệt tác canh tác của người H'Mông.", image: "mu-cang-chai" },
      { name: "Chùa Hương", province: "Hà Nội", type: "Danh thắng tâm linh", highlight: "Quần thể Hương Sơn với động Hương Tích — 'Nam thiên đệ nhất động'.", image: "chua-huong" },
    ],
    tangibleNote:
  ...
  trung: {
    ...
    landmarks: [
      { name: "Quần thể Cố đô Huế", province: "Thừa Thiên Huế", type: "Đô thị cổ", highlight: "Hoàng thành, sông Hương, núi Ngự và 13 lăng tẩm vua Nguyễn — kinh kỳ vàng son một thuở.", image: "hue-citadel" },
      { name: "Phố cổ Hội An", province: "Quảng Nam", type: "Đô thị cổ", highlight: "Thương cảng quốc tế Việt — Hoa — Nhật — Pháp với chùa Cầu và đêm rằm đèn lồng.", image: "hoi-an" },
      { name: "Hang Sơn Đoòng & Phong Nha — Kẻ Bàng", province: "Quảng Bình", type: "Danh thắng", highlight: "Hang động lớn nhất thế giới giữa rừng nguyên sinh karst hơn 400 triệu năm.", image: "son-doong" },
      { name: "Bà Nà Hills & bán đảo Sơn Trà", province: "Đà Nẵng", type: "Danh thắng", highlight: "Cầu Vàng trên đôi bàn tay khổng lồ và rừng nguyên sinh ven biển độc đáo.", image: "ba-na-hills" },
      { name: "Vịnh Lăng Cô & đèo Hải Vân", province: "Huế — Đà Nẵng", type: "Biển đảo", highlight: "Một trong những vịnh biển đẹp nhất thế giới, nhìn xuống từ 'thiên hạ đệ nhất hùng quan'.", image: "hai-van-lang-co" },
      { name: "Mũi Né & đồi cát Bàu Trắng", province: "Bình Thuận", type: "Biển đảo", highlight: "Bãi biển nắng vàng, đồi cát đỏ và làng chài Mũi Né nguyên sơ.", image: "mui-ne" },
      { name: "Cao nguyên Lâm Viên — Đà Lạt", province: "Lâm Đồng", type: "Núi", highlight: "Thành phố ngàn hoa giữa rừng thông, hồ Xuân Hương và biệt thự Pháp cổ.", image: "da-lat" },
      { name: "Biển Nha Trang & vịnh Vân Phong", province: "Khánh Hoà", type: "Biển đảo", highlight: "Vịnh biển trong xanh, đảo Hòn Mun và bùn khoáng Tháp Bà nức tiếng.", image: "nha-trang" },
    ],
    tangibleNote:
  ...
  nam: {
    ...
    landmarks: [
      { name: "Trung tâm Sài Gòn — TP.HCM", province: "TP. Hồ Chí Minh", type: "Đô thị", highlight: "Nhà thờ Đức Bà, Bưu điện Trung tâm, phố đi bộ Nguyễn Huệ — 'Hòn ngọc Viễn Đông'.", image: "saigon" },
      { name: "Đảo ngọc Phú Quốc", province: "Kiên Giang", type: "Biển đảo", highlight: "Đảo lớn nhất Việt Nam với bãi Sao, bãi Khem và rừng nguyên sinh phía Bắc đảo.", image: "phu-quoc" },
      { name: "Côn Đảo", province: "Bà Rịa — Vũng Tàu", type: "Biển đảo", highlight: "Quần đảo của 'địa ngục trần gian' xưa, nay là vườn quốc gia với bãi Đầm Trầu thiên đường.", image: "con-dao" },
      { name: "Chợ nổi Cái Răng", province: "Cần Thơ", type: "Sông nước", highlight: "Chợ nổi sầm uất nhất miền Tây với 'cây bẹo' treo hàng trên ghe thương hồ.", image: "cai-rang" },
      { name: "Mũi Cà Mau", province: "Cà Mau", type: "Danh thắng", highlight: "Điểm cực Nam Tổ quốc, khu dự trữ sinh quyển thế giới với rừng đước Năm Căn.", image: "ca-mau" },
      { name: "Núi Bà Đen", province: "Tây Ninh", type: "Núi", highlight: "'Nóc nhà Nam Bộ' cao 986m với chùa Bà linh thiêng và cáp treo kỷ lục thế giới.", image: "nui-ba-den" },
      { name: "Rừng tràm Trà Sư", province: "An Giang", type: "Danh thắng", highlight: "Rừng ngập nước với thảm bèo xanh ngắt, cò trắng bay rợp trời mùa nước nổi.", image: "tra-su" },
      { name: "Địa đạo Củ Chi", province: "TP. Hồ Chí Minh", type: "Di tích", highlight: "250 km đường hầm ba tầng — 'thành phố ngầm' huyền thoại của kháng chiến Nam Bộ.", image: "cu-chi" },
    ],
    tangibleNote:
