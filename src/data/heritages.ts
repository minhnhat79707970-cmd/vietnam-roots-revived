...
export const heritages: HeritageDetail[] = [
  ...
  },
  {
    ...
    extended: [
      ...
      { heading: "Từ 'Goong Lú' đến chiêng đồng — dấu vết tiền sử", body: "Theo nghiên cứu của GS. Đặng Hoành Loan (Viện Âm nhạc Việt Nam) và GS. G. Condominas, người Tây Nguyên đã có truyền thống chơi nhạc đàn từ thời tiền sử với 'Goong Lú' — bộ đàn đá kêu của người Mnông Gar. Đến một thời điểm trong lịch sử, trục giao thương duyên hải miền Trung — Tây Nguyên — Lào đã đưa cồng chiêng đồng vào Tây Nguyên, dần thay thế Goong Lú. Tiếng chiêng đồng vang xa hơn, nhẹ nhàng hơn nên được người Tây Nguyên 'bản địa hoá' và coi như vật thay thế cho dàn chiêng đá tiền sử." },
      { heading: "Chiêng bằng và chiêng núm — biên chế các tộc người", body: "Cồng chiêng Tây Nguyên có hai loại: chiêng núm (gọi là Chêng) và chiêng bằng (gọi là Chinh). Người Ba Na, Gia Rai, Xơ Đăng, Rơ Măm, Chu Ru thường dùng nhiều chiêng núm; người Ê Đê, Cơ Ho, Giẻ Triêng, Mnông, Mạ thường dùng nhiều chiêng bằng. Dàn lớn nhất có 9–12 chiếc, dàn nhỏ nhất chỉ 2–4 chiếc (như chiêng Tha của người Brâu chỉ có 2 chiếc). Mỗi chiêng được đặt tên theo thành viên gia đình: ông, bà, cha, mẹ, anh, chị, em — thể hiện quan niệm chiêng cũng có 'gia đình' như con người." },
      { heading: "Hàng âm — thang âm độc đáo từng dân tộc", body: "Mỗi dân tộc có hàng âm cồng chiêng riêng: dàn Gia Rai có hàng âm Đồ–Sol–Si–Đô–Rê–Mi–Fa–Sol–Si–Đô–Rế; dàn Ba Na có hàng âm Rề–La–Rê–La–Si–Đô–Rê–Fa–Sol–La–Si; dàn Ê Đê có hàng âm Sì–Đô–Rê–Đô–Rê–Fa–Sol–La–Si; dàn Xơ Đăng có hàng âm Là–Đô–Rê–Fa–Sol–La–Đô–Rê. Người chỉnh chiêng (gọi là 'Pok chinh' hoặc 'Puih chêng') có đôi tai kỳ diệu, ghi nhớ chính xác cao độ chuẩn của từng dàn chiêng và được mời đến chỉnh chiêng trước mọi lễ thức quan trọng." },
      { heading: "Kỹ thuật đánh: dùi mềm, dùi cứng, cườm tay", body: "Người Tây Nguyên có hai cách đánh chiêng: bằng dùi và bằng cườm tay. Dùi mềm (làm từ gốc dứa dại khô hoặc gỗ bọc vải) cho âm thanh tròn trĩnh, vang ngân, trầm hùng. Dùi cứng (nhánh gỗ khô hoặc thân sắn tươi) cho âm sắc nhọn, mãnh liệt như tiếng kim khí va chạm. Đánh bằng cườm tay tạo cảm giác xa xăm, bí ẩn. Tay phải kích vào mặt chiêng tạo âm, tay trái lúc chặn lúc rời mặt chiêng để ngắt và ngân — sự kết hợp nhuần nhuyễn của hai tay tạo nên 'âm chiêng' hoàn chỉnh." },
      { heading: "Bài chiêng — 'tác phẩm' âm nhạc của các nghi lễ", body: "Mỗi bài chiêng ứng với một lễ thức và một dàn chiêng riêng. Trong lễ Bỏ mả (Pthi), người Gia Rai đánh dàn chiêng Arap gồm 16 chiếc với các bài Ania, Mung, Moong, Tơ Rớt... Trong lễ Đâm trâu, người Ba Na chơi dàn chiêng Honh 11 chiếc với các bài Cheng, Spo, Pru hùng tráng. Người Ê Đê có 'Chiêng gọi buôn làng', 'Chiêng gọi hồn lúa', 'Chiêng thác đổ'; người Cơ Ho có 'Voa-nắc' (chiêng đón khách); người Mnông Gar có Booc-ngăn, Rơ-le, Goong-Yowl... Mỗi bài là một 'tác phẩm' âm nhạc hoàn thiện chứa đựng tiếng gió, tiếng suối, tiếng thì thầm của con người trước thiên nhiên bao la." },
    ],
    references: [
      ...
      { title: "Cồng chiêng — một sáng tạo Tây Nguyên", source: "Đặng Hoành Loan, Viện Âm nhạc Việt Nam (vienamnhac.vn)", url: "https://vienamnhac.vn/bai-viet/nhac-co/cong-chieng---mot-sang-tao-tay-nguyen", year: "2017" },
      { title: "Không gian văn hoá Cồng chiêng Tây Nguyên", source: "Tổng cục Du lịch Việt Nam (vietnamtourism.gov.vn)", url: "https://vietnamtourism.gov.vn/post/54171" },
    ],
  },
  {
    slug: "dan-ca-quan-ho",
  ...
  },
  {
    ...
    extended: [
      // ========== PHẦN 1: HỘI GIÓNG ĐỀN PHÙ ĐỔNG ==========
      { heading: "Phần 1 — Hội Gióng đền Phù Đổng (Gia Lâm)", body: "Đền Phù Đổng (xã Phù Đổng, huyện Gia Lâm, Hà Nội) là nơi Thánh Gióng sinh ra và lớn lên. Hội chính mở từ mùng 6 đến mùng 12 tháng 4 âm lịch hằng năm, trong đó ngày mùng 9 là chính hội — được dân gian gọi là 'hội trận', tái hiện cuộc chiến oanh liệt của Thánh Gióng đánh tan giặc Ân." },
      { heading: "Phù Đổng • Không gian và di tích", body: "Cụm di tích gồm đền Thượng (thờ Thánh Gióng), đền Mẫu (thờ mẹ Gióng), chùa Kiến Sơ, miếu Ban (nơi Thánh sinh ra), giá ngự và cố viên. Toàn bộ khuôn viên tái dựng lại không gian huyền thoại — từ nơi sinh, nơi tắm, nơi luyện quân đến chiến trường giả định bên bờ sông Đuống." },
      { heading: "Phù Đổng • Vai diễn nghi lễ", body: "Hội Gióng Phù Đổng có hệ thống vai diễn cha truyền con nối: 4 ông Hiệu (Hiệu Cờ, Hiệu Trống, Hiệu Chiêng, Hiệu Trung quân) chỉ huy trận đánh; 28 cô tướng (tuổi 9–13) đại diện 28 đạo quân nhà Ân; đoàn phù giá khoảng 120 người mặc áo đen; các 'làng áo đỏ', 'làng áo đen' phân vai quân ta — quân địch. Trước hội, các vai phải sống thanh tịnh, kiêng kỵ nghiêm ngặt." },
      { heading: "Phù Đổng • Trận đánh giả Soi Bia", body: "Điểm nhấn của hội Phù Đổng là 'hội trận' diễn ra tại bãi Soi Bia. Ông Hiệu Cờ múa cờ lệnh ba lần trên ba chiếc chiếu — mỗi lần lật bát úp tượng trưng cho một trận thắng. Sau đó là màn cướp chiếu, đánh trống thúc quân, kết thúc bằng nghi thức 'khao quân' với cỗ chay 100 mâm dâng Thánh." },
      { heading: "Phù Đổng • Lễ rước nước và lễ duyệt tướng", body: "Mùng 8 tháng 4: lễ rước nước từ giếng đền Mẫu về tắm khí giới — biểu tượng thanh tẩy trước trận đánh. Cùng ngày diễn ra lễ duyệt tướng: 28 cô tướng được rước bằng kiệu hoa, mặc áo thêu rực rỡ, đeo trang sức quý của dòng họ — vừa là nghi lễ, vừa là dịp 'trình làng' của các thiếu nữ trong vùng." },

      // ========== PHẦN 2: HỘI GIÓNG ĐỀN SÓC ==========
      { heading: "Phần 2 — Hội Gióng đền Sóc (Sóc Sơn)", body: "Đền Sóc nằm trên núi Vệ Linh (xã Phù Linh, huyện Sóc Sơn, Hà Nội) — tương truyền là nơi Thánh Gióng cởi áo giáp, để lại ngựa sắt và bay về trời sau khi đánh thắng giặc Ân. Hội mở từ mùng 6 đến mùng 8 tháng Giêng âm lịch, mở màn cho mùa lễ hội đầu năm của miền Bắc." },
      { heading: "Sóc Sơn • Quần thể di tích", body: "Khu di tích đền Sóc gồm 6 công trình chính: đền Trình, đền Mẫu, chùa Đại Bi, đền Thượng, hòn đá Chồng (tượng trưng dấu chân ngựa Gióng) và tượng đài Thánh Gióng cao 11,07m trên đỉnh núi Đá Chồng (khánh thành 2010 nhân Đại lễ 1000 năm Thăng Long)." },
      { heading: "Sóc Sơn • Lễ rước 8 lễ vật", body: "8 thôn làng quanh đền Sóc mỗi nơi đảm nhiệm rước một lễ vật về dâng Thánh: giò hoa tre (Vệ Linh), voi chiến (Dược Thượng), trầu cau (Đan Tảo), ngà voi (Đức Hậu), cỏ voi (Yên Sào), kiệu tướng (Yên Tàng), cầu húc (Xuân Dục) và nữ tướng trẻ (Yên Phú). Đây là nghi lễ trung tâm thể hiện sự đồng lòng của cộng đồng 8 xã quanh chân núi Sóc." },
      { heading: "Sóc Sơn • Tục cướp giò hoa tre và trầu cau", body: "Sau khi tế lễ, giò hoa tre (làm từ thân tre vót tua thành bông hoa) và trầu cau được tung ra cho dân cướp lộc. Người dân tin rằng cướp được lộc thánh sẽ may mắn, mùa màng bội thu cả năm. Từ năm 2018, do an toàn, tục cướp lộc được tổ chức thành lễ phát lộc trang nghiêm trong đền." },
      { heading: "Sóc Sơn • Tượng trưng cho sự thăng hoa", body: "Nếu hội Phù Đổng diễn lại 'cuộc chiến' thì hội đền Sóc diễn lại 'cuộc thăng hoa' — Thánh Gióng hoàn thành sứ mệnh, từ bỏ vinh hoa và trở về trời. Đây là biểu tượng cao đẹp của tinh thần 'hành động vì cộng đồng, không vì danh lợi' trong văn hoá Việt." },

      // ========== Ý NGHĨA CHUNG ==========
      { heading: "Biểu tượng văn hoá chung", body: "Hai trung tâm hội Gióng — Phù Đổng (sinh ra) và Sóc Sơn (về trời) — tạo thành một chỉnh thể 'sử thi sống' hoàn chỉnh: từ khởi đầu đến kết thúc của huyền thoại Thánh Gióng. Mỗi năm, dân làng cùng nhau diễn lại huyền thoại dựng nước, giữ nước — trao truyền lịch sử và tinh thần thượng võ qua hành động chứ không qua sách vở." },
    ],
    references: [
